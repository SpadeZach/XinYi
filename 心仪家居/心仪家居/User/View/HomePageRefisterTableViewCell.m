//
//  HomePageRefisterTableViewCell.m
//  心仪家居
//
...
@implementation HomePageRefisterTableViewCell
- (void)dealloc
{
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.spaceNameLabel.textColor = [UIColor whiteColor];
        [self.contentView addSubview:self.spaceNameLabel];
        [_spaceNameLabel release];
        
        self.styleNameLabel = [[UILabel alloc] init];
        self.styleNameLabel.textColor = [UIColor whiteColor];
